...
var persistentJobId = batchelor.persistent.execute(
    [
        ...
        },
        {
            ...
            ignoreResponse: true,
            callback: function (err, result) {
                console.log("req_with_callback_10000_persistent: " + JSON.stringify(result));
            }
        },
        {
            ...
            ignoreResponse: true,
            callback: function (err, result) {
                console.log("req_with_callback_5000_persistent: " + JSON.stringify(result));
            }
        }], function (err, result) {
        console.log("\nCALLBACK GENERAL BATCHELOR PERSISTENT: " + JSON.stringify(result));
    })
